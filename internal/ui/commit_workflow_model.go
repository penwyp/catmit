...
// HandleGlobalKeys handles global keyboard shortcuts with commit-specific behavior
func (m *CommitWorkflowModel) HandleGlobalKeys(msg tea.KeyMsg) (bool, tea.Cmd) {
...
func (m *CommitWorkflowModel) updateActionsForPhase() {
	...
	case WorkflowPhasePRPreview:
		// PR preview actions
		m.SetActions([]Action{
			{Key: "Enter", Label: "Continue", Handler: func() tea.Cmd {
...
func (m *CommitWorkflowModel) updatePRPreview(msg tea.KeyMsg) (tea.Model, tea.Cmd) {
	...
	// Handle commit workflow specific keys
	switch msg.String() {
	case "enter", " ":
