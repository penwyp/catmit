...
- **多种提供商**: 支持 DeepSeek、OpenAI、Azure OpenAI、Anthropic、Gemini、火山引擎方舟、Ollama 以及任何 OpenAI 兼容 API
...
| 变量 | 描述 | 必需 | 默认值 |
|------|------|------|--------|
| `CATMIT_LLM_PROVIDER` | LLM 提供商类型（`azure`、`anthropic`、`gemini`、`ollama`、`cli` 或留空使用 OpenAI 兼容） |  否 | OpenAI 兼容 |
